...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter_ascending-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15080&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter_ascending-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter_ascending` can be installed with:

```
conda install jupyter_ascending
```

It is possible to list all of the versions of `jupyter_ascending` available on your platform with:
